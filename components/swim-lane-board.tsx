...
export function SwimLaneBoard({
  ...
  const { dragState, handleDragStart, handleDragOver, handleDragLeave, handleDrop, handleDragEnd } = useTaskDragDrop()
      ...
      <div className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {swimlanes.map((swimlane) => {
            const swimlaneTasks = tasks.filter((task) => task.swimlane_id === swimlane.id)
            ...
            return (
              <SwimLaneColumn
                ...
                onDrop={(e) => handleDrop(e, swimlane.id, swimlaneTasks, tasks, handleTasksReorder)}
