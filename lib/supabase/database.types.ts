    ...
    Tables: {
      ...
      tasks: {
        Row: {
          ...
          attr_afp: number | null;
          attr_input: number | null;
          attr_output: number | null;
          attr_enquiry: number | null;
          attr_file: number | null;
          attr_interface: number | null;
          attr_resource: number | null;
          attr_duration: number | null;
          created_at: string | null;
          description: string | null;
